...
$id=$_GET['id'];
include('dbcon.php');
$sql=mysqli_query($con,"SELECT * FROM `farmerview108` WHERE farmerid='$id'");
...
if(isset($_POST['add']))
{
	...
	$qry=mysqli_query($con,"UPDATE `farmerview108`SET `firstname`='$n',`middlename`='$m1',`lastname`='$m2' WHERE farmerid='$id'")or die(mysqli_error($con));
if($qry==true)
{
	echo "
	<script>
